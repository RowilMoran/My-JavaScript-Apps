        ...
        for (let j = 0; j < cardTitle.length; j++) {
            if (array[i].card.title === cardTitle[j].innerText) {
                ...
                Object.keys(resourcesInCard).forEach(e=> {
                    ...
                    const linkNameCont = document.createElement("div");
                    ...
                    linkNameCont.appendChild(resourceLink);
                    
                    //set icon redirect
                    LinkIcon.setAttribute("src", "Resources/saveYourResources/icons/external-link.png")
                    resourceLink.appendChild(LinkIcon);
                    //linkName 
                    resourceName.innerText = resourcesInCard[e].name;
                    linkNameCont.appendChild(resourceName);
                    //append name and icon 
                    linkNameCont.classList.add("name-icon-link");
                    linkContainer.appendChild(linkNameCont);
